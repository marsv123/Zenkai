        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 justify-items-center">
            {journeySteps.map((step, index) => (
              ...
              >
                {/* Step Number Badge */}
                <div className="absolute top-6 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-primary text-primary-foreground text-sm font-bold flex items-center justify-center z-10">
                  {step.step}
                </div>
